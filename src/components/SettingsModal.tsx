    ...
    <Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.about}><View style={styles.appMark}><Ionicons name="barbell" size={25} color={colors.darkText} /></View><Text style={styles.appName}>{appMetadata.name}</Text><Text style={styles.version}>Version {appMetadata.version}</Text><Text style={styles.aboutText}>Your workout data is stored locally on this device.</Text></View>
        </ScrollView>
